...
const install = async (info, excludes = undefined, preserveType = undefined, toDirUserDefined = {}) => {
  const path = require('path');
  const fse = require('fs-extra');

  const installed = require('./../js/install_inno')(info, excludes, toDirUserDefined);
  if (installed) {
